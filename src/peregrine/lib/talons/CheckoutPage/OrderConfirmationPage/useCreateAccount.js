...
export const useCreateAccount = props => {
    ...
    const [createAccount, { error: createAccountError, data: createAccountCheckoutdata }] = useMutation(
        createAccountMutation,
        {
    ...
    const handleSubmit = useCallback(
        async formValues => {
            ...
            try {
                ...
                await createAccount({
                    variables: {
                        email: formValues.customer.email || formValues.email,
                        ...
                        mobilenumber: formValues.customer.mobilenumber
                    }
                });
    ...
    return {
        errors,
        confirmation_msg:
            createAccountCheckoutdata &&
            createAccountCheckoutdata.createCustomer.message,
        handleSubmit,
