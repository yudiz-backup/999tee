...
import { useAppContext } from '@magento/peregrine/lib/context/app.js';
import { useCatalogContext } from '@magento/peregrine/lib/context/catalog.js';
...
import DEFAULT_OPERATIONS from '@magento/peregrine/lib/talons/Navigation/navigation.gql.js';
...
export const useNavigation = (props = {}) => {
    ...
    const isOpen = drawer === 'nav' || drawer === 'sign-in';
