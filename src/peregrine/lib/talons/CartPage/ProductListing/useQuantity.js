...
export const useQuantity = props => {
    const { initialValue, min, onChange/* , propHandleDecrement=()=> {}, propHandleIncrement=()=>{}  */ } = props;
    ...
    const handleDecrement = useCallback(() => {
        ...
        // propHandleDecrement(newQuantity)
    ...
    const handleIncrement = useCallback(() => {
        ...
        quantityFieldApi.setValue(newQuantity);
        debouncedOnChange(newQuantity);
        // propHandleIncrement(newQuantity)
    }, [debouncedOnChange, quantity, quantityFieldApi]);
    ...
    const handleBlur = useCallback(() => {
        ...
        if (quantity === undefined) {
            quantityFieldApi.setValue(prevQuantity)
            debouncedOnChange(prevQuantity)
        }
