...
import { useSummary } from 'src/peregrine/lib/talons/CheckoutPage/PaymentInformation/useSummary';
...
const Summary = props => {
    ...
    if (selectedPaymentMethod && selectedPaymentMethod.code !== 'braintree') {
        return (
