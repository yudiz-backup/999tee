...
const MyOrderView = props => {
    ...
    useEffect(() => {
        if (reoderResponse?.reorderItems) {
            var err = reoderResponse?.reorderItems?.userInputErrors;
            if (err.length == 0) {
                history.push('/cart', { reOrder: true });
            }
        }
                            ...
                            {typeof data != 'undefined' && (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {reoderResponse?.reorderItems?.userInputErrors !== 0 ?
                                            <div>
                                                {reoderResponse?.reorderItems?.userInputErrors?.map(err =>
                                            ...
                                            >
                                                <ul
                                                    className={
                                                        ...
                                                        ' ' +
                                                        defaultClasses.table_head + ' ' + defaultClasses.table_head_none
                                                    }
                                                >
                                                    <li
                                                        className={
                                                    ...
                                                    {data?.items?.map(
                                                        (val, index) => {
                                                            return (
                                                                ...
                                                                >
                                                                    <li data-th="Product Name"
                                                                        className={
                                                                            'col table_field_name' +
                                                                            ' ' +
                                                                            defaultClasses.name
                                                                        }
                                                                    >
                                                                        ...
                                                                        {/* <div className={defaultClasses.detail_label + ' ' + defaultClasses.invoice_clasess}>
                                                                            {val &&
                                                                                val.options &&
                                                                                val.options.map(
                                                                                    (
                                                                                        ...
                                                                                        return (
                                                                                            <div
                                                                                                ...
                                                                                                className={
                                                                                                    defaultClasses.optionLabel + ' ' + defaultClasses.order_table_details
                                                                                                }
                                                                                            >
                                                                                                <dt className={defaultClasses.none_label}>
                                                                                                    {
                                                                                                        optionVal.label + ' '
                                                                                                    }
                                                                                                </dt>
