...
import defaultClasses from '../Disclaimer/disclaimer.css';

export default function BannerViewMoreContent(props) {
    ...
    let disclaimerIdentifier = 'banner-view-more-content';
    if (typeof HomeConfigData != 'undefined') {
        for (var i = 0; i < HomeConfigData.length; i++) {
            if (HomeConfigData[i]['name'] == 'banner-view-more-content')
